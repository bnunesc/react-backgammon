        ...
        <div id="board" className="container-fluid">
            ...
            <div id="leftSide" className="row">
                ...
                <div className="blocksUp">
                    ...
                    >
                        {getPieces(props.points[12].player, props.points[12].checkers, "board", props.points[12].canMove)}
                    </Triangle>
                    ...
                    >
                        {getPieces(props.points[13].player, props.points[13].checkers, "board", props.points[13].canMove)}
                    </Triangle>
                    ...
                    >
                        {getPieces(props.points[14].player, props.points[14].checkers, "board", props.points[14].canMove)}
                    </Triangle>
                    ...
                    >
                        {getPieces(props.points[15].player, props.points[15].checkers, "board", props.points[15].canMove)}
                    </Triangle>
                    ...
                    >
                        {getPieces(props.points[16].player, props.points[16].checkers, "board", props.points[16].canMove)}
                    </Triangle>
                    ...
                    >
                        {getPieces(props.points[17].player, props.points[17].checkers, "board", props.points[17].canMove)}
                    </Triangle>
                ...
                <div className="blocksDown">
                    ...
                    >
                        {getPieces(props.points[11].player, props.points[11].checkers, "board", props.points[11].canMove)}
                    </Triangle>
                    ...
                    >
                        {getPieces(props.points[10].player, props.points[10].checkers, "board", props.points[10].canMove)}
                    </Triangle>
                    ...
                    >
                        {getPieces(props.points[9].player, props.points[9].checkers, "board", props.points[9].canMove)}
                    </Triangle>
                    ...
                    >
                        {getPieces(props.points[8].player, props.points[8].checkers, "board", props.points[8].canMove)}
                    </Triangle>
                    ...
                    >
                        {getPieces(props.points[7].player, props.points[7].checkers, "board", props.points[7].canMove)}
                    </Triangle>
                    ...
                    >
                        {getPieces(props.points[6].player, props.points[6].checkers, "board", props.points[6].canMove)}
                    </Triangle>
                </div>
            ...
            <div id="rightSide" className=" row">
                ...
                <div className="blocksUp">
                    ...
                    >
                        {getPieces(props.points[18].player, props.points[18].checkers, "board", props.points[18].canMove)}
                    </Triangle>
                    ...
                    >
                        {getPieces(props.points[19].player, props.points[19].checkers, "board", props.points[19].canMove)}
                    </Triangle>
                    ...
                    >
                        {getPieces(props.points[20].player, props.points[20].checkers, "board", props.points[20].canMove)}
                    </Triangle>
                    ...
                    >
                        {getPieces(props.points[21].player, props.points[21].checkers, "board", props.points[21].canMove)}
                    </Triangle>
                    ...
                    >
                        {getPieces(props.points[22].player, props.points[22].checkers, "board", props.points[22].canMove)}
                    </Triangle>
                    ...
                    >
                        {getPieces(props.points[23].player, props.points[23].checkers, "board", props.points[23].canMove)}
                    </Triangle>
                </div>
                ...
                <div className="blocksDown">
                    ...
                    >
                        {getPieces(props.points[5].player, props.points[5].checkers, "board", props.points[5].canMove)}
                    </Triangle>
                    ...
                    >
                        {getPieces(props.points[4].player, props.points[4].checkers, "board", props.points[4].canMove)}
                    </Triangle>
                    ...
                    >
                        {getPieces(props.points[3].player, props.points[3].checkers, "board", props.points[3].canMove)}
                    </Triangle>
                    ...
                    >
                        {getPieces(props.points[2].player, props.points[2].checkers, "board", props.points[2].canMove)}
                    </Triangle>
                    ...
                    >
                        {getPieces(props.points[1].player, props.points[1].checkers, "board", props.points[1].canMove)}
                    </Triangle>
                    ...
                    >
                        {getPieces(props.points[0].player, props.points[0].checkers, "board", props.points[0].canMove)}
                    </Triangle>
